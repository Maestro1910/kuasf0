...
int main(int argc, char *argv[])
{
    ...
    m_pal.setColor(QPalette::WindowText, QColor(0, 0, 0)); // Черный цвет для текста
    m_pal.setColor(QPalette::Button, QColor(255, 255, 255)); // Белый цвет для фона кнопок
    m_pal.setColor(QPalette::ButtonText, QColor(0, 0, 0)); // Черный цвет для текста на кнопках
